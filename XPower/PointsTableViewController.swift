...
class PointsTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        let cell = CustomerCell(frame: CGRectMake(0, 0, self.view.frame.width, 150), title:pointsListArray[Array(pointsListArray.keys)[indexPath.section]]![indexPath.row], object: self, row:indexPath.row, section:indexPath.section)
